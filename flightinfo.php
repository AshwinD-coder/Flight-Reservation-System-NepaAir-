...
{   echo "<td> $row2[1] </td><td> $row2[2] </td><td> $row2[3] </td><td> $row2[9] </td><td> $row[12] </td><td> $row2[5] </td><td>$row[13]</td><td></td><td><a style='text-decoration:none; color:white;' href='cancel.php'>Cancel flight</a>";
}}}}
else{
